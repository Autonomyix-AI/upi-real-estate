            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
                    ...
                    <div className="flex flex-col items-start md:items-end gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-full border border-[#2a2a2a] flex items-center justify-center text-[#a0a0a0] hover:text-[#D4A017] hover:border-[#D4A017] transition-all duration-300"
                ...
                <div className="mt-12 pt-8 border-t border-[#1a1a1a] text-center">
                    <p className="text-[#555] text-sm">
                        © 2025 Unique Property Investments. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
